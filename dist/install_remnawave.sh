...
TRANSLATIONS_EN[telegram_enable_tblocker_notifications]="Do you want to enable Torrent Blocker notifications? (the tblocker service itself is installed on nodes separately)"
...
TRANSLATIONS_RU[telegram_enable_tblocker_notifications]="Хотите ли вы включить уведомления Torrent Blocker? (сам сервис tblocker устанавливается на ноды отдельно)"
